...
def _kokkos_flags() -> tuple[str, list[str], list[str]]:
    ...
    print("[ERROR] No se pudo detectar la instalación de Kokkos.")
    print(f"        .env esperado en: {ENV_PATH}")
    print("        Define KOKKOS_CXXFLAGS y KOKKOS_LDFLAGS en .env,")
    print("        o asegúrate de que kokkos_config está en el PATH.")
    sys.exit(1)
